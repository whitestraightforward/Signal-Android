...
APK size: by default the build ships only ARM native libraries (no x86 / no fat universal APK), compresses JNI, and shrinks unused resources on release. See [APK-SIZE.md](APK-SIZE.md).
