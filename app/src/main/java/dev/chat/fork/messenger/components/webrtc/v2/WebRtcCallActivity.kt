...
import dev.chat.fork.messenger.components.webrtc.CallLinkProfileKeySender
import dev.chat.fork.messenger.components.webrtc.CallParticipantsState
import dev.chat.fork.messenger.components.webrtc.GroupCallSafetyNumberChangeNotificationUtil
import dev.chat.fork.messenger.components.webrtc.InCallStatus
import dev.chat.fork.messenger.components.webrtc.PendingParticipantsBottomSheet
import dev.chat.fork.messenger.components.webrtc.WebRtcAudioDevice
import dev.chat.fork.messenger.components.webrtc.WebRtcAudioOutput
import dev.chat.fork.messenger.components.webrtc.WebRtcControls
import dev.chat.fork.messenger.components.webrtc.requests.CallLinkIncomingRequestSheet
import dev.chat.fork.messenger.conversation.ui.error.SafetyNumberChangeDialog
import dev.chat.fork.messenger.dependencies.AppDependencies
import dev.chat.fork.messenger.events.WebRtcViewModel
import dev.chat.fork.messenger.keyvalue.SignalStore
import dev.chat.fork.messenger.messagerequests.CalleeMustAcceptMessageRequestActivity
...
import dev.chat.fork.messenger.webrtc.CallParticipantsViewState
import dev.chat.fork.messenger.webrtc.audio.SignalAudioManager
import dev.chat.fork.messenger.webrtc.audio.SignalAudioManager.ChosenAudioDeviceIdentifier
...
class WebRtcCallActivity : BaseActivity(), SafetyNumberChangeDialog.Callback, ReactWithAnyEmojiBottomSheetDialogFragment.Callback, RecaptchaProofBottomSheetFragment.Callback {
  ...
  private suspend fun observeVideoSinkAspectRatio(videoSink: dev.chat.fork.messenger.components.webrtc.BroadcastVideoSink?) {
