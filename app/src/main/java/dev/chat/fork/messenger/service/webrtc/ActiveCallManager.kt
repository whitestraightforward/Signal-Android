...
import dev.chat.fork.messenger.webrtc.UncaughtExceptionHandlerManager
import dev.chat.fork.messenger.webrtc.audio.AudioManagerCommand
import dev.chat.fork.messenger.webrtc.audio.SignalAudioManager
import dev.chat.fork.messenger.webrtc.audio.SignalAudioManager.Companion.create
...
class ActiveCallManager(
  ...
  class ActiveCallServiceReceiver : BroadcastReceiver() {
    ...
    companion object {
      const val ACTION_DENY = "dev.chat.fork.messenger.service.webrtc.ActiveCallAction.DENY"
      const val ACTION_HANGUP = "dev.chat.fork.messenger.service.webrtc.ActiveCallAction.HANGUP"
    }
