...
import dev.chat.fork.messenger.database.SqlCipherLibraryLoader.load
import dev.chat.fork.messenger.database.model.MegaphoneRecord
import dev.chat.fork.messenger.megaphone.Megaphones
import kotlin.concurrent.Volatile

/**
 * IMPORTANT: Writes should only be made through [dev.chat.fork.messenger.megaphone.MegaphoneRepository].
 */
