...
import dev.chat.fork.messenger.ShortcutLauncherActivity
import dev.chat.fork.messenger.attachments.TombstoneAttachment
import dev.chat.fork.messenger.avatar.fallback.FallbackAvatarDrawable
import dev.chat.fork.messenger.components.emoji.EmojiStrings
...
import dev.chat.fork.messenger.conversation.v2.RequestReviewState.GroupReviewState
import dev.chat.fork.messenger.conversation.v2.RequestReviewState.IndividualReviewState
import dev.chat.fork.messenger.conversation.v2.data.ConversationDataSource
...
import dev.chat.fork.messenger.dependencies.AppDependencies.databaseObserver
import dev.chat.fork.messenger.dependencies.AppDependencies.expiringMessageManager
import dev.chat.fork.messenger.groups.GroupNotAMemberException
import dev.chat.fork.messenger.jobs.GroupSendJobHelper
import dev.chat.fork.messenger.jobs.MultiDeviceViewOnceOpenJob
import dev.chat.fork.messenger.jobs.UnpinMessageJob
import dev.chat.fork.messenger.keyboard.KeyboardUtil
import dev.chat.fork.messenger.keyvalue.SignalStore.Companion.settings
import dev.chat.fork.messenger.linkpreview.LinkPreview
import dev.chat.fork.messenger.messagerequests.MessageRequestState
...
import dev.chat.fork.messenger.profiles.spoofing.ReviewRecipient
...
import dev.chat.fork.messenger.sms.MessageSender.PreUploadResult
import dev.chat.fork.messenger.transport.UndeliverableMessageException
import dev.chat.fork.messenger.util.AdaptiveBitmapMetrics
...
import dev.chat.fork.messenger.util.hasTextSlide
import dev.chat.fork.messenger.util.isViewOnceMessage
import dev.chat.fork.messenger.util.requireTextSlide
...
class ConversationRepository(
  ...
  private val oldConversationRepository = dev.chat.fork.messenger.conversation.ConversationRepository()
