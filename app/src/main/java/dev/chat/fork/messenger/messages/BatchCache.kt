 ...
 * no batching is possible, mostly when the [dev.chat.fork.messenger.jobs.PushProcessMessageJob] runs.
 */
...
/**
 * This is intended to be used in [IncomingMessageObserver] to batch jobs (e.g., [dev.chat.fork.messenger.jobs.SendDeliveryReceiptJob])
