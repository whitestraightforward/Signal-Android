...
object AvatarBundler {
  ...
  private const val TEXT = "dev.chat.fork.messenger.avatar.TEXT"
  private const val COLOR = "dev.chat.fork.messenger.avatar.COLOR"
  private const val URI = "dev.chat.fork.messenger.avatar.URI"
  private const val KEY = "dev.chat.fork.messenger.avatar.KEY"
  private const val DATABASE_ID = "dev.chat.fork.messenger.avatar.DATABASE_ID"
  private const val SIZE = "dev.chat.fork.messenger.avatar.SIZE"
