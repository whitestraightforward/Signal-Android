...
package dev.chat.fork.messenger.webrtc.audio
 ...
 *
 * Device availability and active device updates flow from [dev.chat.fork.messenger.service.webrtc.TelecomCallController] directly
 * to [dev.chat.fork.messenger.service.webrtc.SignalCallManager.onAudioDeviceChanged], bypassing this class entirely.
 */
@RequiresApi(34)
