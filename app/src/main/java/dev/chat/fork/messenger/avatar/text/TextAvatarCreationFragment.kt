...
import dev.chat.fork.messenger.avatar.picker.AvatarPickerItem
import dev.chat.fork.messenger.components.BoldSelectionTabItem
import dev.chat.fork.messenger.components.ControllableTabLayout
...
class TextAvatarCreationFragment : Fragment(R.layout.text_avatar_creation_fragment) {
  ...
  companion object {
    const val REQUEST_KEY_TEXT = "dev.chat.fork.messenger.avatar.text.TEXT"
  }
}
