...
import dev.chat.fork.messenger.webrtc.audio.SignalAudioHandler
 ...
 * reports that to the [dev.chat.fork.messenger.webrtc.audio.SignalAudioManager], and then handles connecting/disconnecting
 * to the device if requested by [dev.chat.fork.messenger.webrtc.audio.SignalAudioManager].
 */
