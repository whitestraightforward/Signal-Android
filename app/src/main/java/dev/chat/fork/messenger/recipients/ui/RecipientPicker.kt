...
import dev.chat.fork.messenger.recipients.ui.RecipientPicker.DisplayMode.Companion.flag
import dev.chat.fork.messenger.recipients.ui.RecipientPicker.KeyboardType
...
object RecipientPicker {
  /**
   * Enum wrapper for [dev.chat.fork.messenger.contacts.ContactSelectionDisplayMode].
   */
