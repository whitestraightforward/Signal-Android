...
import dev.chat.fork.messenger.backup.v2.ImportSkips
import dev.chat.fork.messenger.backup.v2.ImportState
import dev.chat.fork.messenger.backup.v2.util.toLocalAttachment
...
import dev.chat.fork.messenger.database.model.databaseprotos.PaymentTombstone
...
import dev.chat.fork.messenger.payments.CryptoValueUtil
import dev.chat.fork.messenger.payments.Direction
import dev.chat.fork.messenger.payments.FailureReason
import dev.chat.fork.messenger.payments.State
import dev.chat.fork.messenger.payments.proto.PaymentMetaData
import dev.chat.fork.messenger.polls.Voter
...
class ChatItemArchiveImporter(
  ...
  private fun LinkPreview.toLocalLinkPreview(): dev.chat.fork.messenger.linkpreview.LinkPreview {
    return dev.chat.fork.messenger.linkpreview.LinkPreview(
      this.url,
      this.title ?: "",
      this.description ?: "",
      this.date ?: 0,
