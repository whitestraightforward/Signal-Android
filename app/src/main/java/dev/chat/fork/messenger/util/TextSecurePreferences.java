...
import dev.chat.fork.messenger.lock.RegistrationLockReminders;
...
public class TextSecurePreferences {
  ...
  /**
   * @deprecated Use {@link SettingsValues#getMessageFontSize()} via {@link dev.chat.fork.messenger.keyvalue.SignalStore} instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link SettingsValues#getTheme()} via {@link dev.chat.fork.messenger.keyvalue.SignalStore} instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link SettingsValues#getLanguage()} via {@link dev.chat.fork.messenger.keyvalue.SignalStore} instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link SettingsValues#setLanguage(String)} via {@link dev.chat.fork.messenger.keyvalue.SignalStore} instead.
   */
  @Deprecated
