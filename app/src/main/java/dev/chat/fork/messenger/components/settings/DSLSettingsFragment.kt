...
abstract class DSLSettingsFragment(
  ...
  /**
   * All host windows are edge-to-edge — activities centrally via [dev.chat.fork.messenger.BaseActivity],
   * and the full-screen dialog hosts ([dev.chat.fork.messenger.components.WrapperDialogFragment],
   * [dev.chat.fork.messenger.stories.settings.create.CreateStoryFlowDialogFragment]) via their own
