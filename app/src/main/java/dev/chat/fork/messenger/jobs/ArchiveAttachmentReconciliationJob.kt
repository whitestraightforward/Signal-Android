...
import dev.chat.fork.messenger.jobs.protos.ArchiveAttachmentReconciliationJobData
...
class ArchiveAttachmentReconciliationJob private constructor(
  ...
  /**
   * Deletes attachments from the archive CDN, after verifying that they also can't be found anywhere in [dev.chat.fork.messenger.database.AttachmentTable]
