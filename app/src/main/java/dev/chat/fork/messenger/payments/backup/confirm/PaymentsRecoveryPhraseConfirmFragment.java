package dev.chat.fork.messenger.payments.backup.confirm;
...
public class PaymentsRecoveryPhraseConfirmFragment extends Fragment {
  ...
  public static final  String   REQUEST_KEY_RECOVERY_PHRASE = "dev.chat.fork.messenger.payments.backup.confirm.RECOVERY_PHRASE";
