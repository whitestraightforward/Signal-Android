...
/**
 * A convenient way to access network operations, similar to [dev.chat.fork.messenger.database.SignalDatabase] and [dev.chat.fork.messenger.keyvalue.SignalStore].
 */
