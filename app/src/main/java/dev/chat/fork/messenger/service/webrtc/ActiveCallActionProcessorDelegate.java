...
import dev.chat.fork.messenger.webrtc.audio.OutgoingRinger;

import java.util.HashMap;
import java.util.Map;
import java.util.Objects;

import static dev.chat.fork.messenger.webrtc.CallNotificationBuilder.TYPE_ESTABLISHED;
import static dev.chat.fork.messenger.webrtc.CallNotificationBuilder.TYPE_INCOMING_CONNECTING;
import static dev.chat.fork.messenger.webrtc.CallNotificationBuilder.TYPE_INCOMING_RINGING;
import static dev.chat.fork.messenger.webrtc.CallNotificationBuilder.TYPE_OUTGOING_RINGING;
