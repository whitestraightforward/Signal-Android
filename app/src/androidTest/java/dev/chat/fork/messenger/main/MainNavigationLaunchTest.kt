...
import dev.chat.fork.messenger.mediasend.v2.MediaSelectionActivity
...
class MainNavigationLaunchTest {
  ...
  /**
   * Mirrors [dev.chat.fork.messenger.sharing.v2.ShareActivity.openConversation]. We
  ...
  /**
   * Mirrors the image-share path through [dev.chat.fork.messenger.sharing.v2.ShareActivity.openConversation]:
  ...
  /**
   * Mirrors [dev.chat.fork.messenger.deeplinks.DeepLinkEntryActivity]: bare clearTop
