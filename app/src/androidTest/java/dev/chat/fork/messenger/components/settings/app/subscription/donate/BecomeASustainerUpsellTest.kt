...
import dev.chat.fork.messenger.badges.self.none.BecomeASustainerFragment
import dev.chat.fork.messenger.badges.self.overview.BadgesOverviewFragment
 ...
 * tests assert the "user might be a sustainer" rule in [dev.chat.fork.messenger.profiles.manage.EditProfileFragment]:
