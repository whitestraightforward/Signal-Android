...
import dev.chat.fork.messenger.components.settings.app.subscription.donate.gateway.GatewaySelectorTestTags
import dev.chat.fork.messenger.components.settings.app.subscription.donate.paypal.PayPalConfirmationDialogFragment
import dev.chat.fork.messenger.components.settings.app.subscription.donate.paypal.PayPalConfirmationResult
import dev.chat.fork.messenger.components.settings.app.subscription.donate.stripe.Stripe3DSDialogFragment
import dev.chat.fork.messenger.components.settings.app.subscription.donate.transfer.DonationTransferTestTags
import dev.chat.fork.messenger.testing.actions.scrollToDescendant
import dev.chat.fork.messenger.testing.endpoints.StripeResponses
import dev.chat.fork.messenger.testing.flushUntil
...
class CheckoutFlowDriver(
  ...
  /**
   * Fills the [dev.chat.fork.messenger.components.settings.app.subscription.donate.card.CreditCardFragment]
