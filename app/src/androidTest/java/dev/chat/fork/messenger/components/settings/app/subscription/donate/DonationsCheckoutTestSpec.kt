...
import dev.chat.fork.messenger.testing.endpoints.DonationResponses
import dev.chat.fork.messenger.testing.endpoints.EndpointResponse
import dev.chat.fork.messenger.testing.endpoints.MockEndpoints
import dev.chat.fork.messenger.testing.endpoints.StripeResponses
import dev.chat.fork.messenger.testing.endpoints.failure
import dev.chat.fork.messenger.testing.endpoints.ok
import dev.chat.fork.messenger.testing.endpoints.registerPayPalHappyPath
import dev.chat.fork.messenger.testing.endpoints.registerStripeHappyPath
 ...
 * the shared responder (overriding the [dev.chat.fork.messenger.testing.InAppPaymentsRule]
...
sealed interface ExpectedOutcome {
  ...
  /**
   * Payment setup succeeded and the payment moved past [dev.chat.fork.messenger.database.InAppPaymentTable.State.CREATED]
