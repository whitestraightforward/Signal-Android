...
package dev.chat.fork.messenger.conversation.plaintext
...
import dev.chat.fork.messenger.conversation.plaintext.PlaintextExportRepository.PendingAttachment
import dev.chat.fork.messenger.database.FakeMessageRecords
...
class PlaintextExportRepositoryTest {
  ...
  fun setUp() {
    ...
    val mockLiveRecipient = mockk<dev.chat.fork.messenger.recipients.LiveRecipient>(relaxed = true)
  ...
  private fun renderMessage(
    message: dev.chat.fork.messenger.database.model.MmsMessageRecord,
    attachments: List<dev.chat.fork.messenger.attachments.DatabaseAttachment> = emptyList(),
