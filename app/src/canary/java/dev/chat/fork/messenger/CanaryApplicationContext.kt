  ...
  override fun onCreate() {
    ...
    LeakCanary.config = LeakCanary.config.copy(
      referenceMatchers = AndroidReferenceMatchers.appDefaults +
        ...
        AndroidReferenceMatchers.ignoredInstanceField(
          className = "dev.chat.fork.messenger.components.voice.VoiceNotePlaybackService",
          fieldName = "mApplication"
        ) +
        AndroidReferenceMatchers.ignoredInstanceField(
          className = "dev.chat.fork.messenger.service.GenericForegroundService\$LocalBinder",
          fieldName = "this\$0"
        ) +
        AndroidReferenceMatchers.ignoredInstanceField(
          className = "dev.chat.fork.messenger.contacts.ContactsSyncAdapter",
          fieldName = "mContext"
        )
    )
  }
