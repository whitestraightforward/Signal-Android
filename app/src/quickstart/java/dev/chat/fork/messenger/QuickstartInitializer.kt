...
import dev.chat.fork.messenger.registration.data.QuickstartCredentials
...
object QuickstartInitializer {
  ...
  private val diskCredentialFileName: String
    get() = if (dev.chat.fork.messenger.util.Environment.IS_STAGING) "staging_credentials.json" else "prod_credentials.json"
